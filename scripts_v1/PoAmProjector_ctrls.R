...
load(file="/home/PERSONALE/katarzyn.kwiatkowsk2/sysdata.rda") # loads model
...
score <- PoAmProjector(betas,proportionOfProbesRequired=0.8)$DunedinPoAm
...
save(score,file=paste0(out_dir,"/",experimental_name,"_DunedinPoAm_score.RData",sep=""))
...
save(out, file=paste0(out_dir,"/",experimental_name,"_mPACE_output.RData"))
